...
struct ns16550::regs {
	...
	union {
		using S = uint8_t;
		struct { S r; };
		bf::bit<S, bool, 3> EDSSI;  /* Modem Status */
		bf::bit<S, bool, 2> ELSI;   /* Receie Line Status */
		bf::bit<S, bool, 1> ETBEI;  /* Transmit Hold Register Empty */
		bf::bit<S, bool, 0> ERBFI;  /* Received Data Available */
	} IER;
	uint8_t IIR_FCR;
	uint8_t LCR;
	uint8_t MCR;
...
ns16550::ns16550(void *base)
: r_{static_cast<regs *>(base)}
{
 ...
 */
void
ns16550::early_init(void *base, unsigned long clock, tcflag_t)
{
 ...
 */
void
ns16550::early_print(void *base, const char *s, size_t len)
{
	ns16550 u{base};
